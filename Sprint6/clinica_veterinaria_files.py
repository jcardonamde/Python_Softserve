"""
Ejercicio Sprint6: Sistema Completo de Gestión para Veterinaria con Serialización CSV y JSON

Extiende el sistema de gestión para permitir guardar y cargar datos de mascotas, dueños y consultas
usando archivos CSV (para mascotas y dueños) y JSON (para consultas) - Clínica Veterinaria "Amigos Peludos"
